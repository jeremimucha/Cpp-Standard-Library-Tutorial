// timepoint.hpp -- Ch5 Utilities -- converting calendar times into timepoints
#ifndef TIMEPOINT_HPP_
#define TIMEPOINT_HPP_
...
makeTimePoint(int year, int mon, int day, int hour, int min, int sec=0)
{
    ...
    if(tt == -1){
        throw "no vlaid system time";
    }
    return std::chrono::system_clock::from_time_t(tt);
}


#endif /*TIMEPOINT_HPP_*/
