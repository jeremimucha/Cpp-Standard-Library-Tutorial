// Chapter 11 Algorithms -- copy copy_backward
...
int main()
{
    ...
    copy(c1.cbegin()+10, c1.cbegin()+16,
         c1.begin()+7); // this argument must NOT be part of the source range
    ...
    copy_backward(c2.cbegin()+10, c2.cbegin()+16,
                  c2.begin()+19); // this argument must NOT be part of the source range
